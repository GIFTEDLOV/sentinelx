"""Build and validate the stable Studionet source manifest."""
...
OUTPUT = ROOT / "deployments" / "studionet" / "SOURCE_MANIFEST.json"
SOURCES = {
...
def build_manifest(*, source_commit: str | None = None) -> dict[str, object]:
    return {
        "schema": "sentinelx-studionet-stable-source-manifest-v1",
        "release": "SentinelX V2.2 Studionet Stable",
        "git_commit": source_commit or git_head(),
        "network": "studionet",
        ...
        "toolchain": {
            ...
            "genlayer_test_install_note": "genlayer-test 0.29.2 installed with --no-deps because its published metadata excludes the required stable genlayer-py 0.18 family; import and test execution were verified together.",
        },
        "historical_rc_revisions_preserved": ["V2", "V2.1", "V2.2 Studio-dev"],
