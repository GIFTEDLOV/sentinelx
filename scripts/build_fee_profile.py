...
PROFILE = ROOT / "artifacts" / "v2.1" / "fee-profile.json"
REQUESTED_METHODS = (
...
def build_profile_from_journal(
    ...
    coverage_path = ROOT / "artifacts" / "v2.1" / "fee-profile-coverage.json"
...
def main() -> int:
    ...
    if args.from_journal is not None:
        ...
        print(json.dumps({"profile": str(PROFILE), "coverage": str(ROOT / "artifacts" / "v2.1" / "fee-profile-coverage.json"), "observed_methods": observed_methods}, indent=2))
        return 0
